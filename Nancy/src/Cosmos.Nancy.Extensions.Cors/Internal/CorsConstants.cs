 ...
 * https://github.com/aspnet/CORS/blob/dev/src/Microsoft.AspNetCore.Cors/Infrastructure/CorsConstants.cs
 * */
...
namespace Cosmos.Nancy.Extensions.Internal
{
    ...
    public static class CorsConstants
    {
        ...
        /// </summary>
        public static readonly string AccessControlAllowMethods = "Allow-Control-Allow-Methods";

        /// <summary>
        /// The Access-Control-Allow-Credentials response header.
        /// </summary>
        public static readonly string AccessControlAllowCredentials = "Allow-Control-Allow-Credentials";
